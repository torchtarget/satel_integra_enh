...
class SatelReadCommand(SatelBaseCommand):
    ...
    OUTPUTS_STATE = 0x17
    TROUBLES_PART_0 = 0x1A
    TROUBLES_PART_1 = 0x1B
    TROUBLES_PART_2 = 0x1C
    TROUBLES_PART_3 = 0x1D
    TROUBLES_PART_4 = 0x1E
    TROUBLES_PART_5 = 0x1F
    TROUBLES_MEMORY_PART_0 = 0x20
    TROUBLES_MEMORY_PART_1 = 0x21
    TROUBLES_MEMORY_PART_2 = 0x22
    TROUBLES_MEMORY_PART_3 = 0x23
    TROUBLES_MEMORY_PART_4 = 0x24
    TROUBLES_MEMORY_PART_5 = 0x25
